# Configuration file for jupyterhub-singleuser.
import os
...
#------------------------------------------------------------------------------
# JupyterHubSingleUser(ExtensionApp) configuration
#------------------------------------------------------------------------------
...
## Answer yes to any prompts.
#  See also: JupyterApp.answer_yes
# c.JupyterHubSingleUser.answer_yes = False

## Full path of a config file.
#  See also: JupyterApp.config_file
# c.JupyterHubSingleUser.config_file = ''

## Specify a config file to load.
#  See also: JupyterApp.config_file_name
# c.JupyterHubSingleUser.config_file_name = ''

#  See also: ExtensionApp.default_url
# c.JupyterHubSingleUser.default_url = ''

## Generate default config file.
#  See also: JupyterApp.generate_config
# c.JupyterHubSingleUser.generate_config = False

## Handlers appended to the server.
#  See also: ExtensionApp.handlers
# c.JupyterHubSingleUser.handlers = []

## Interval (in seconds) on which to update the Hub with our latest activity.
#  Default: 300
# c.JupyterHubSingleUser.hub_activity_interval = 300

## URL for sending JupyterHub activity updates
#  Default: ''
# c.JupyterHubSingleUser.hub_activity_url = ''

## The date format used by logging formatters for %(asctime)s
#  See also: Application.log_datefmt
# c.JupyterHubSingleUser.log_datefmt = '%Y-%m-%d %H:%M:%S'

## The Logging format template
#  See also: Application.log_format
# c.JupyterHubSingleUser.log_format = '[%(name)s]%(highlevel)s %(message)s'

## Set the log level by value or name.
#  See also: Application.log_level
# c.JupyterHubSingleUser.log_level = 30

## 
#  See also: Application.logging_config
# c.JupyterHubSingleUser.logging_config = {}

## Whether to open in a browser after starting.
#  See also: ExtensionApp.open_browser
# c.JupyterHubSingleUser.open_browser = False

## Settings that will passed to the server.
#  See also: ExtensionApp.settings
# c.JupyterHubSingleUser.settings = {}

## Instead of starting the Application, dump configuration to stdout
#  See also: Application.show_config
# c.JupyterHubSingleUser.show_config = False

## Instead of starting the Application, dump configuration to stdout (as JSON)
#  See also: Application.show_config_json
# c.JupyterHubSingleUser.show_config_json = False

## paths to search for serving static files.
#  See also: ExtensionApp.static_paths
# c.JupyterHubSingleUser.static_paths = []

## Url where the static assets for the extension are served.
#  See also: ExtensionApp.static_url_prefix
# c.JupyterHubSingleUser.static_url_prefix = ''

## Paths to search for serving jinja templates.
#  See also: ExtensionApp.template_paths
# c.JupyterHubSingleUser.template_paths = []
